...
def initialize():
    ...
    cmd_q4 = multiprocessing.Queue()
    cmd_q5 = multiprocessing.Queue()
    ...
    process3 = multiprocessing.Process(target=device_worker, args=(TAG3_COM, 3, cmd_q3, result_q), daemon=True)
    process4 = multiprocessing.Process(target=device_worker, args=(TAG4_COM, 4, cmd_q4, result_q), daemon=True)
    process5 = multiprocessing.Process(target=device_worker, args=(TAG5_COM, 5, cmd_q5, result_q), daemon=True)
...
def MPPMultiWays(cmdq_rx_lst:list,cmdq_tx, result_q):
...
def mainMultiWays(run_exp_num, freq_range=FREQ_RANGE, repetitions=INBUILT_REPETITIONS):
    exc.set_pwr(EXC_POWER)
    exp_no=getExperimentNo()
    
    all_cmd_queues=[cmd_q1,cmd_q2,cmd_q3,cmd_q4,cmd_q5]
    all_tag_names=["Tag1", "Tag2", "Tag3", "Tag4", "Tag5"]
    all_tag_names=[1, 2, 3, 4, 5]
    ...
    try:
        for freq in freq_range:
            ...
            for i in range(len(all_cmd_queues)):
                Tx_queue = all_cmd_queues[i]                # single element
                Tx_tag_name = all_tag_names[i]                # single element
            ...
            #         "MPP Start Time (s)":mpp_start_time_1, 
            #         "MPP Stop Time (s)":mpp_stop_time_1, 
            #         "Voltages (mV)":voltage_readings_1[1],
            #         "Frequency (MHz)":freq, 
            #         "Run Exp Num":run_exp_num,
            #         "NumMPPs": repetitions
            #         },
            ...
            #         "MPP Start Time (s)":mpp_start_time_1, 
            #         "MPP Stop Time (s)":mpp_stop_time_1, 
            #         "Voltages (mV)":voltage_readings_1[3],
            #         "Frequency (MHz)":freq, 
            #         "Run Exp Num":run_exp_num,
            #         "NumMPPs": repetitions
            #         },
            ...
            #     "Voltages (mV)":voltage_readings_2[2],
            #     "Frequency (MHz)":freq, 
            #     "Run Exp Num":run_exp_num,
            #     "NumMPPs": repetitions
            #     },
            ...
            #     "MPP Start Time (s)":mpp_start_time_2, 
            #     "MPP Stop Time (s)":mpp_stop_time_2, 
            #     "Voltages (mV)":voltage_readings_2[3],
            #     "Frequency (MHz)":freq, 
            #     "Run Exp Num":run_exp_num,
            #     "NumMPPs": repetitions
            #     },
            ...
            #     {"Rx":"Tag1", 
            #     "Tx":"Tag3", 
            #     "MPP Start Time (s)":mpp_start_time_3, 
            #     "MPP Stop Time (s)":mpp_stop_time_3, 
            #     "Voltages (mV)":voltage_readings_3[1],
            #     "Frequency (MHz)":freq, 
            #     "Run Exp Num":run_exp_num,
            #     "NumMPPs": repetitions
            #     },
            ...
            #     "MPP Start Time (s)":mpp_start_time_3, 
            #     "MPP Stop Time (s)":mpp_stop_time_3, 
            #     "Voltages (mV)":voltage_readings_3[2],
            #     "Frequency (MHz)":freq, 
            #     "Run Exp Num":run_exp_num,
            #     "NumMPPs": repetitions
            #     },
